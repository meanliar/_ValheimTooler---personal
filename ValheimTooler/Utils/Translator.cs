...
namespace ValheimTooler.Utils
{
    public class VTLocalization
    {
        ...
        public static readonly string s_flyOn = "$vt_fly_on";
        public static readonly string s_cheatOff = "$vt_cheat_off";
        public static readonly string s_activateAll = "$vt_activateall";
        public static readonly string s_deactivateAll = "$vt_deactivateall";
