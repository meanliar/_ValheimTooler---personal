...
namespace ValheimTooler.Utils
{
    public sealed class ConfigManager
    {
        ...
        public Vector2 s_emotePickerInitialPosition = new Vector2(Screen.width - 400, 5);
        public bool s_permanentPins = false;
        public bool s_espRadiusEnabled = false;
        public float s_espRadius = 5.0f;
        public float s_flightSpeed = 20.0f;
        ...
        private ConfigManager()
        {
            ...
            if (File.Exists(internalFilePath))
            {
                ...
                if (_internalConfiguration.Contains("Internal"))
                {
                    ...
                    if (internalSection.Contains("EmotePickerLocationX") && internalSection.Contains("EmotePickerLocationY"))
                    {
                        var emotePickerLocationX = internalSection["EmotePickerLocationX"].FloatValue;
                        var emotePickerLocationY = internalSection["EmotePickerLocationY"].FloatValue;
                        s_emotePickerInitialPosition = new Vector2(emotePickerLocationX, emotePickerLocationY);
                    }
        ...
        public void SaveConfig()
        {
            ...
            _internalConfiguration["Internal"]["EmotePickerLocationX"].FloatValue = s_emotePickerInitialPosition.x;
            _internalConfiguration["Internal"]["EmotePickerLocationY"].FloatValue = s_emotePickerInitialPosition.y;
