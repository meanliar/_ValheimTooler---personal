    ...
    public static class PlayerExtensions
    {
        ...
        public static void VTHeal(this Player player)
        {
            if (player != null)
            {
                ...
                float current_stamina = player.GetStamina();
                float max_stamina = player.GetMaxStamina();
                float stamina_increase = max_stamina - current_stamina;
                player.AddStamina(stamina_increase);
            }
        }
